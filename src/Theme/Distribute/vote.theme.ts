...
export const voteTheme = {
    ...
    voteEachParticipantsColor: Color.title03,
    voteEachContentColor: Color.title04,
    voteEachAuthorColor: Color.title07,
    ...
    voteDetailResultWinningPercentageColor: Color.mainBrightTheme,
    voteDetailResultPercentageColor: Color.title05,
    voteDetailResultURLShareButtonColor: Color.title03,

    //// voteDetail - footer
    voteDetailFooterTextColor: Color.title03,

    // voteOther
    voteOtherHeaderColor: Color.title03,
    voteOtherTagColor: Color.title04,
    voteOtherTitleColor: Color.title04,
};
